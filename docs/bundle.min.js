!(function(e) {
  ...
  function(e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }), r(n(8)), r(n(10));
  },
  function(e, t, n) {
    'use strict';
  ...
  function(e, t, n) {
    ...
    (t.displayVersion = () => {
      o.runOnDocumentReady(() => {
        document.getElementById('version').textContent = r.version.slice(0, 8);
      });
    }),
      (t.debug = () =>
        o.runOnDocumentReady(() => {
          ...
          let a, c, u;
          i.getLastCommandStream().subscribe((e) => (a = e)),
            i.getCommandHistoryStream().subscribe((e) => (c = e)),
            i.debug3().subscribe((e) => (u = e));
          const s = () => {
            a && o(JSON.stringify(a, null, 2), 'left-top'),
              c && o(JSON.stringify(c, null, 2), 'left-bot'),
              u && o(JSON.stringify(u, null, 2), 'right-top'),
  ...
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.version = '011d55a4e342ecc459fa5386913dbfac3d63b865');
  },
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  function(e, t, n) {
    ...
    t.detectMovingMovement = (e) => {
      const t = o.simplifyMovements([
        ...
        i = t[1],
        a = t[2];
      return 0 === n.rate && 0 === i.rate
        ? 1 < a.rate
          ? 'quick start'
          : 'slow start'
        : n.rate < 2 && 3 <= Math.abs(i.rate) && 3 <= Math.abs(a.rate - i.rate)
        ? 0 === a.rate
          ? 'just return'
          : 'over return'
        : 'moving';
