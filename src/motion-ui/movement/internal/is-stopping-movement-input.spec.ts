...
describe('isStoppingMovementInput', () => {
  it('should work', () => {
    ...
    const invalid: any[] = [nonZero, nonZero, nonZero, nonZero, nonZero, nonZero, nonZero, nonZero, nonZero, zero];
    const valid: any[] = [nonZero, nonZero, nonZero, nonZero, nonZero, nonZero, nonZero, nonZero, zero, zero];
